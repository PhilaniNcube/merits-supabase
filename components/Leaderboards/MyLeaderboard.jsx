...
const MyLeaderboard = ({leaderboard}) => {
  ...
  return <div className="px-4 py-6 bg-fuchsia-900 rounded-xl">
      {leaderboard.map((item, i) => {
        return (
          <div key={item.id} className="mb-1 py-2 px-3 bg-fuchsia-800 flex items-center justify-between rounded-sm">
